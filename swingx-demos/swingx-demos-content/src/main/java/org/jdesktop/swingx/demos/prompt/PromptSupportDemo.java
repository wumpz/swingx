...
public class PromptSupportDemo extends JPanel {
	...
	private void bind() {
		...
		backgroundPainter.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				PromptSupport.setBackgroundPainter(
						((DisplayInfo<Painter>) backgroundPainter.getSelectedItem()).getValue(), textField);
			}
		});
	...
	private JPanel buildControlPanel() {
		...
		JButton foregroundColor = new JButton(new AbstractAction("Select Foreground") {
			...
			public void actionPerformed(ActionEvent e) {
				Color color = JColorChooser.showDialog(
						PromptSupportDemo.this, "Foreground Color", PromptSupport.getForeground(textField));
		...
		JButton backgroundColor = new JButton(new AbstractAction("Select Background") {
			...
			public void actionPerformed(ActionEvent e) {
				Color color = JColorChooser.showDialog(
						PromptSupportDemo.this, "Background Color", PromptSupport.getBackground(textField));
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				JFrame frame = new JFrame(PromptSupportDemo.class
