...
public class DatePickerDemo extends JXPanel {
	...
	private void bind() {
		...
		group.addBinding(Bindings.createAutoBinding(
				READ, datePicker, BeanProperty.create("date"), dateEchoField, BeanProperty.create("value")));

		group.addBinding(Bindings.createAutoBinding(
				READ, interactivity, BeanProperty.create("selected"), datePicker, BeanProperty.create("enabled")));

		group.addBinding(Bindings.createAutoBinding(
				READ, editability, BeanProperty.create("selected"), datePicker, BeanProperty.create("editable")));
		...
		Binding b = Bindings.createAutoBinding(
				...
				datePicker,
				BeanProperty.create("componentOrientation"));
	...
	private void initComponents() {
		...
		FormLayout formLayout = new FormLayout(
				...
				"c:d:n " + ", t:4dlu:n, c:d:n" + ", t:4dlu:n, c:d:n" + ", t:4dlu:n, c:d:n"); // rows
		...
		JLabel datePickerLabel = builder.addLabel(
				"", cl.xywh(labelColumn, currentRow, 1, 1), datePicker, cc.xywh(widgetColumn, currentRow, 1, 1));
		...
		JLabel dateEchoLabel = builder.addLabel(
				"", cl.xywh(labelColumn, currentRow, 1, 1), dateEchoField, cc.xywh(widgetColumn, currentRow, 1, 1));
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				JFrame frame = new JFrame(
						DatePickerDemo.class.getAnnotation(DemoProperties.class).value());
