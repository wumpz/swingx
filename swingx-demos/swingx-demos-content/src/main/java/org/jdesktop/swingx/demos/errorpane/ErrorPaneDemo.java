...
public class ErrorPaneDemo extends DefaultDemoPanel {
	...
	public void generateDialogWithOwner() {
		ErrorInfo info =
				new ErrorInfo("title", "basic error message", null, "category", new Exception(), Level.ALL, null);
	...
	public void generateNestedExceptions() {
		...
		ErrorInfo info = new ErrorInfo("Title", "basic error message", null, "category", ex, Level.ALL, null);
		JXErrorPane.showDialog(this, info);
	}
}
