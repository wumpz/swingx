...
public class TitledPanelDemo extends JXPanel {
	...
	private void bind() {
		...
		// </snip>
		Binding fontBinding = Bindings.createAutoBinding(
				UpdateStrategy.READ,
				fontChooserCombo,
				BeanProperty.create("selectedItem"),
				titledPanel,
				BeanProperty.create("titleFont"));
		fontBinding.setConverter(new DisplayInfoConverter<Font>());
		group.addBinding(fontBinding);

		Binding backgroundBinding = Bindings.createAutoBinding(
				UpdateStrategy.READ,
				backgroundChooserCombo,
				BeanProperty.create("selectedItem"),
				titledPanel,
				BeanProperty.create("titlePainter"));
	...
	private JXPanel createFirstCard() {
		...
		JLabel titleLabel = builder.addLabel(
				"", cl.xywh(labelColumn, currentRow, 1, 1), titleField, cc.xywh(widgetColumn, currentRow, 1, 1));
		currentRow += 2;
		...
		JLabel fontLabel = builder.addLabel(
				"", cl.xywh(labelColumn, currentRow, 1, 1), fontChooserCombo, cc.xywh(widgetColumn, currentRow, 1, 1));
		currentRow += 2;
		...
		JLabel backgroundLabel = builder.addLabel(
				"",
