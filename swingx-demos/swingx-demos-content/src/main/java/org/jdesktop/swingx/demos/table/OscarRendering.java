...
public class OscarRendering {
	...
	public static void configureColumnFactory(CustomColumnFactory factory, Class<?> resourceBase) {
		...
		factory.addComponentProvider(
				"movieTitleColumn", new HyperlinkProvider(new OscarCandidateLinkAction(), OscarCandidate.class));
