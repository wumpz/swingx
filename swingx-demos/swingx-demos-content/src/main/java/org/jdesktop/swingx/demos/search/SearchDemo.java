	...
	public class SearchControl extends AbstractBean {
		...
		public SearchControl() {
			...
			group.addBinding(Bindings.createAutoBinding(
					...
					this,
					BeanProperty.create("extendedMarker")));
			group.addBinding(Bindings.createAutoBinding(
					READ, painterBox, BeanProperty.create("selected"), this, BeanProperty.create("animatedPainter")));
			group.addBinding(Bindings.createAutoBinding(
					READ, this, BeanProperty.create("extendedMarker"), painterBox, BeanProperty.create("enabled")));
			group.bind();
		}
