...
public class HyperlinkDemo extends JPanel {
	...
	private void bind() throws URISyntaxException {
		...
		linkTree.setCellRenderer(
				new DefaultTreeRenderer(new WrappingProvider(new HyperlinkProvider(new HyperlinkAction()))));
		// </snip>
	...
	private Action createLinkAction() {
		...
		AbstractHyperlinkAction<?> action = new AbstractHyperlinkAction<Object>() {
			...
			public void setVisited(boolean visited) {
				...
				setSmallIcon(
						isVisited()
								? getResourceIcon("customAction.verifiedIcon")
								: getResourceIcon("customAction.unverifiedIcon"));
				setName(
						isVisited()
								? getResourceString("customAction.verifiedText")
