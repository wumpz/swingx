...
public class LoadedXDemoPanel extends JXTitledPanel {
	...
	public LoadedXDemoPanel(Demo demo) throws Exception {
		...
		if (descriptionArea != null) demoPanel.setBorder(DemoXPanel.roundedBorder);
		applyDefaults();
	}
	...
	private void layoutWithDescription() {
		...
		JScrollPane scrollPane = new JScrollPane(
				descriptionArea, JScrollPane.VERTICAL_SCROLLBAR_NEVER, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
	...
	private void applyDefaults() {
		...
		GradientPaint gradient = new GradientPaint(
				0f,
				0f,
				UIManager.getColor(SwingXSet.TITLE_GRADIENT_COLOR1_KEY),
				500f,
				0f,
