...
public class AWTUtilitiesWrapper {
	...
	private static final Logger LOG = Logger.getLogger(AWTUtilitiesWrapper.class.getName());
	...
	private static boolean getBoolean(Method method, Object kind, boolean valueOnFailure) {
		if (hasMethod(method)) {
			try {
