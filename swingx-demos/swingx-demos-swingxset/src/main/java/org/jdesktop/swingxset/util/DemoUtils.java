...
public class DemoUtils {
	...
	private static void fadeOutAndEnd(final Window window, int fadeOutDuration, final boolean exit) {
		...
		dispose.addPropertyToInterpolate(
				"opacity",
				1.0f,
		...
		dispose.addCallback(new UIThreadTimelineCallbackAdapter() {
			...
			public void onTimelineStateChanged(
					TimelineState oldState, TimelineState newState, float durationFraction, float timelinePosition) {
