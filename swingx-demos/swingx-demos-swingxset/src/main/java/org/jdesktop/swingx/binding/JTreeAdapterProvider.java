...
public final class JTreeAdapterProvider implements BeanAdapterProvider {
	...
	public final class Adapter extends BeanAdapterBase {
		...
		protected void listeningStarted() {
			...
			cachedElementOrElements =
					isPlural() ? getSelectedElements() : JTreeAdapterProvider.getSelectedElement(tree);
	...
	private static Object getSelectedElement(JTree tree) {
		...
		index = tree.getSelectionModel().isRowSelected(index)
				? index
				: tree.getSelectionModel().getMinSelectionRow();
