 ...
 */
@Disabled
public class LookAndFeelAddonsSandboxDebug extends LookAndFeelAddonsSandboxOnTest {
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(LookAndFeelAddonsSandboxDebug.class.getName());
	...
	public void testServiceLoaderPrivileged() {
		...
		assertTrue(
				loader.iterator().hasNext(), "loader must have addons: fails here because the loading happens lazily");
	}
