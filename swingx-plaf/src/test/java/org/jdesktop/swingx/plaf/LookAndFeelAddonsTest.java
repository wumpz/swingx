...
public class LookAndFeelAddonsTest {
	...
	public void testInstallBackgroundPainterWithoutPainterCapable() {
		assertThrows(
				IllegalArgumentException.class, () -> LookAndFeelAddons.installBackgroundPainter(new JPanel(), null));
	}
	...
	public void testInstallBackgroundPainterWithNullComponent() {
		assertThrows(
				NullPointerException.class, () -> LookAndFeelAddons.installBackgroundPainter(null, "test.painter"));
	}
