...
public abstract class BeanInfoSupport extends SimpleBeanInfo {
			...
			try {
				...
				if (beanDescriptor != null) {
					...
					beanDescriptor = new BeanDescriptor(
							...
							customizerClass == null ? beanDescriptor.getCustomizerClass() : customizerClass);
				} else {
	...
	protected void setDisplayName(String displayName, String propertyName) {
		...
		if (pd != null) {
			...
			LOG.log(
					Level.WARNING,
					"Failed to set display name for property '" + propertyName + "'. No such property was found");
		}
	}
	...
	protected void setTransient(boolean trans, String... propertyNames) {
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set transient attribute for property '" + propertyName
	...
	protected void setHidden(boolean hidden, String... propertyNames) {
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set hidden attribute for property '" + propertyName
								+ "'. No such property was found");
			}
		}
	}
	...
	protected void setExpert(boolean expert, String... propertyNames) {
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set expert attribute for property '" + propertyName
								+ "'. No such property was found");
			}
		}
	}
	...
	protected void setPreferred(boolean preferred, String... propertyNames) {
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set preferred attribute for property '" + propertyName
								+ "'. No such property was found");
			}
		}
	}
	...
	protected void setBound(boolean bound, String... propertyNames) {
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set bound attribute for property '" + propertyName
								+ "'. No such property was found");
			}
		}
	}
	...
	protected void setConstrained(boolean constrained, String... propertyNames) {
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set constrained attribute for property '" + propertyName
								+ "'. No such property was found");
			}
		}
	}
	...
	protected void setCategory(String categoryName, String... propertyNames) {
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set category for property '" + propertyName + "'. No such property was found");
			}
		}
	}
	...
	protected void setPropertyEditor(Class<?> editorClass, String... propertyNames) {
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set property editor for property '" + propertyName
								+ "'. No such property was found");
			}
		}
	}
	...
	protected void setEnumerationValues(EnumerationValue[] values, String... propertyNames) {
		...
		for (String propertyName : propertyNames) {
			...
			if (pd != null) {
				...
				LOG.log(
						Level.WARNING,
						"Failed to set enumeration values for property '" + propertyName
								+ "'. No such property was found");
			}
		}
	}
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		return isIntrospecting() ? null : properties.values().toArray(new PropertyDescriptor[0]);
	}
	...
	public EventSetDescriptor[] getEventSetDescriptors() {
		return isIntrospecting() ? null : events.values().toArray(new EventSetDescriptor[0]);
	}
	...
	public MethodDescriptor[] getMethodDescriptors() {
		return isIntrospecting() ? null : methods.values().toArray(new MethodDescriptor[0]);
	}
