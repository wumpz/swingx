	...
	protected void initialize() {
		...
		setEnumerationValues(
				new EnumerationValue[] {
					...
					new EnumerationValue(
							"Bold & Italic", Font.BOLD | Font.ITALIC, "java.awt.Font.BOLD | java.awt.Font.ITALIC")
				},
				"promptFontStyle");
		setEnumerationValues(
				new EnumerationValue[] {
					...
					new EnumerationValue(
							...
							"org.jdesktop.swingx.prompt.PromptSupport.FocusBehavior.HIGHLIGHT_PROMPT"),
				},
				"focusBehavior");
	}
}
