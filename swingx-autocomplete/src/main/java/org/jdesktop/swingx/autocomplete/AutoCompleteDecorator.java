...
public class AutoCompleteDecorator {
	...
	private static void installMap(InputMap componentMap, boolean strict) {
		...
		if (strict) {
			map.put(
					KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_BACK_SPACE, 0),
	...
	public static void decorate(JComboBox comboBox, ObjectToStringConverter stringConverter) {
		...
		final AutoCompleteDocument document =
				createAutoCompleteDocument(adaptor, strictMatching, stringConverter, editorComponent.getDocument());
	...
	public static void decorate(JList list, JTextComponent textComponent, ObjectToStringConverter stringConverter) {
		...
		AutoCompleteDocument document =
				createAutoCompleteDocument(adaptor, true, stringConverter, textComponent.getDocument());
	...
	public static void decorate(
		...
		AutoCompleteDocument document =
				createAutoCompleteDocument(adaptor, strictMatching, stringConverter, textComponent.getDocument());
		decorate(textComponent, document, adaptor);
	}
	 ...
	 */
	public static void decorate(
			JTextComponent textComponent, AutoCompleteDocument document, AbstractAutoCompleteAdaptor adaptor) {
	...
	static class NonStrictBackspaceAction extends TextAction {
		...
		public NonStrictBackspaceAction(
				Action backspace, Action selectionBackward, AbstractAutoCompleteAdaptor adaptor) {
