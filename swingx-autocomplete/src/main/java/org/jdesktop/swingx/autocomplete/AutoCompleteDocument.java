...
public class AutoCompleteDocument implements Document {
	...
	// Note: these comparators do not impose any ordering - e.g. they do not ensure that sgn(compare(x, y)) ==
	// -sgn(compare(y, x))
	 ...
	 */
	public AutoCompleteDocument(
			AbstractAutoCompleteAdaptor adaptor, boolean strictMatching, ObjectToStringConverter stringConverter) {
