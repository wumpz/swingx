...
public class JXListSortRevamp extends InteractiveTestCase {
	...
	public void interactiveXRowSorterSharedXTable() {
		...
		JXFrame frame =
				showWithScrollingInFrame(table, core, "xtables (shared sortController): shared model/sorter/selection");
		Action fireAllChanged = new AbstractAction("fireDataChanged") {
	...
	public void interactiveXRowSorterShared() {
		...
		JXFrame frame = showWithScrollingInFrame(
				table, core, "core tables (shared sortController): shared model/sorter/selection");
		Action fireAllChanged = new AbstractAction("fireDataChanged") {
