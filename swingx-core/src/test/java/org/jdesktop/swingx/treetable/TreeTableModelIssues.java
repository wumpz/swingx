...
public class TreeTableModelIssues extends InteractiveTestCase {
	...
	private static final Logger LOG = Logger.getLogger(TreeTableModelIssues.class.getName());
	...
	public void testTreeStructureChangedEmptyPath() {
		...
		assertNotNull(path.getLastPathComponent(), "TreePath must not contain null path elements");
	}
}
