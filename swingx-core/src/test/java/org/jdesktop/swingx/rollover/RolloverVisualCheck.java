...
public class RolloverVisualCheck extends InteractiveTestCase {
	...
	private static final Logger LOG = Logger.getLogger(RolloverVisualCheck.class.getName());
	...
	public void interactiveExitToChild() {
		...
		table.addHighlighter(
				new ColorHighlighter(HighlightPredicate.ROLLOVER_ROW, Color.MAGENTA, null, Color.MAGENTA, null));
	...
	private JXFrame getResizableFrame(final JComponent table) {
		...
		table.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT)
				.put(KeyStroke.getKeyStroke("A"), "horizontalDecrease");
		...
		table.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT)
				.put(KeyStroke.getKeyStroke("D"), "horizontalIncrease");
		...
		table.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT)
				.put(KeyStroke.getKeyStroke("W"), "verticalDecrease");
		...
		table.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT)
				.put(KeyStroke.getKeyStroke("S"), "verticalIncrease");
	...
	public void interactiveTreeTableRolloverHierarchical() {
		...
		HighlightPredicate andPredicate = new AndHighlightPredicate(
				new HighlightPredicate.ColumnHighlightPredicate(0), HighlightPredicate.ROLLOVER_ROW);
		final Highlighter foregroundHighlighter = new ColorHighlighter(andPredicate, null, Color.MAGENTA);
		final Highlighter backgroundHighlighter = new ColorHighlighter(andPredicate, Color.YELLOW, null);
	...
	public void setUp() throws Exception {
		...
		foregroundHighlighter = new ColorHighlighter(HighlightPredicate.ROLLOVER_ROW, null, Color.MAGENTA);
		backgroundHighlighter = new ColorHighlighter(HighlightPredicate.ROLLOVER_ROW, Color.YELLOW, null);
	}
}
