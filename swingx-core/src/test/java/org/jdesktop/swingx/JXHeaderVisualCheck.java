...
public class JXHeaderVisualCheck extends InteractiveTestCase {
	...
	public void interactiveFontLayoutReset() {
		...
		final JXHeader header = new JXHeader("My Title", "<html>My short description<br>some text<html>");
	...
	public void interactiveHTMLTextWrapShort() {
		...
		header.setTitle("AlbumManager");
		String headerShort =
				"An adaption from JGoodies Binding Tutorial in the context" + " of BeansBinding/AppFramework. ";
	...
	public void interactiveWordWrapping() {
		...
		JPanel p = new JPanel(new BorderLayout());
		JXHeader header = new JXHeader(
				"MyTitle", "this is a long test with veeeeeeeeeeeeeery looooooong wooooooooooooords", icon);
		p.add(header);
	...
	public void interactiveCustomTitleFont() {
		...
		final JXHeader header = new JXHeader(
				"MyBigUglyTitle", "this is a long test with veeeeeeeeeeeeeery looooooong wooooooooooooords", icon);
