...
public class TargetableActionTest {
	...
	public static TargetableAction createTargetableAction(
			String id, String name, String mnemonic, boolean toggle, String group) {
	...
	public static void showUI() {
		...
		manager.addAction(createTargetableAction("left-justify", "Left", "L", true, "position-group"));
		manager.addAction(createTargetableAction("center-justify", "Center", "C", true, "position-group"));
		manager.addAction(createTargetableAction("right-justify", "Right", "R", true, "position-group"));
