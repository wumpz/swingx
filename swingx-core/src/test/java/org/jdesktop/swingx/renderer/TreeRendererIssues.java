...
public class TreeRendererIssues extends InteractiveTestCase {
	...
	public void interactiveTransparentRenderer() throws IOException {
		...
		Action edit = new AbstractActionExt("edit") {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String changed = oldName.length() > 60
	...
	public void testTreeIconsUpdateUI() {
		...
		WrappingIconPanel before =
				(WrappingIconPanel) renderer.getTreeCellRendererComponent(tree, "", false, false, true, -1, false);
	...
	public void testTreeRendererExtColors() {
		...
		// prepare extended
		Component xComponent = xTreeRenderer.getTreeCellRendererComponent(tree, null, false, false, false, 0, false);
