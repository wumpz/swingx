...
public class StringValuesTest {
	...
	public void testFileNameWithNonFile() {
		...
		assertEquals(StringValues.TO_STRING.getString(o), StringValues.FILE_NAME.getString(o));
	}
	...
	public void testFileNameWithFile() throws Exception {
		...
		assertNotSame(StringValues.EMPTY.getString(f), StringValues.FILE_NAME.getString(f));
	}
	...
	public void testFileTypeWithNonFile() {
		...
		assertEquals(StringValues.TO_STRING.getString(o), StringValues.FILE_TYPE.getString(o));
	}
