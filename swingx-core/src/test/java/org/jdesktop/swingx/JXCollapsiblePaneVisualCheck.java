...
public class JXCollapsiblePaneVisualCheck extends InteractiveTestCase {
	...
	public void interactiveAnimationSizingTest() {
		...
		button.addActionListener(collPane.getActionMap().get(JXCollapsiblePane.TOGGLE_ACTION));
	...
	public void interactiveFocusTest() {
		...
		JButton button = new JButton("Toggle");
		button.addActionListener(instance.getActionMap().get(JXCollapsiblePane.TOGGLE_ACTION));
		panel.add(button, BorderLayout.CENTER);
