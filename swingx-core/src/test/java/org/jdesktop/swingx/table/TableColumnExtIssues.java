...
public class TableColumnExtIssues {
	...
	public void testResizableBoundProperty() {
		...
		if (!columnExt.getResizable()) {
			assertEquals(1, report.getEventCount("resizable"), "fixing column widths must fire resizable ");
		} else {
	...
	public void testSerializable() throws IOException, ClassNotFoundException {
		...
		PropertyChangeListener[] listeners = serialized.getPropertyChangeListeners();
