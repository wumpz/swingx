...
public class TableUtilitiesTest extends InteractiveTestCase {
	...
	public void testPrefRowHeightMustBarkOnNull() {
		assertThrows(NullPointerException.class, () -> TableUtilities.getPreferredRowHeight(null, -1));
	}
	...
	public void testRemove() {
		// correct detection of insert/remove
		TableModelEvent remove = new TableModelEvent(getModel(), 0, 10, -1, TableModelEvent.DELETE);
