...
public class TableRowHeightControllerTest extends InteractiveTestCase {
	...
	private static final Logger LOG = Logger.getLogger(TableRowHeightControllerTest.class.getName());
	...
	private JXTable createXTableWithIndyRowHeights() {
		...
		FontHighlighter highlighter =
				new FontHighlighter(predicate, table.getFont().deriveFont(50f));
