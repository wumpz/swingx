...
public class JXTableIssues extends InteractiveTestCase {
	...
	public void testCellEditorFired() {
		...
		assertEquals(report.getCanceledEventCount(), report.getEventCount(), "total count must be equals to canceled");
		...
		assertEquals(report.getStoppedEventCount(), report.getEventCount(), "total count must be equals to stopped");
	...
	public void testModifyTableContentAndSelection() {
		CompareTableBehaviour compare =
				new CompareTableBehaviour(new Object[] {"A", "B", "C", "D", "E", "F", "G", "H", "I"});
	...
	private DefaultTableModel createAscendingModel(
