...
public class JXEditorPaneVisualCheck extends JXEditorPaneTest {
	...
	public void interactiveXEditorStyledActions() throws IOException {
		...
		JXFrame frame = wrapWithScrollingInFrame(
				editor, list, "Looking at swingx editor default and styled actions (show in editor <--> list)");
	...
	public void interactiveXEditorActions() {
		...
		actions.add(ActionFactory.createTargetableAction("left-justify", "Left", "L", true, "position-group"));
		actions.add(ActionFactory.createTargetableAction("center-justify", "Center", "C", true, "position-group"));
		actions.add(ActionFactory.createTargetableAction("right-justify", "Right", "R", true, "position-group"));
