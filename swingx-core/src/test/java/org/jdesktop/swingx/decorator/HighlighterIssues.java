...
public class HighlighterIssues extends org.jdesktop.swingx.InteractiveTestCase {
	...
	public void testLookupUIColor() {
		...
		hl.updateUI();
		assertFalse(color.equals(hl.getBackground()), "highlighter background must be changed");
	}
	...
	public void interactiveTableCustomCoreRendererColorBasedOnValue() {
		...
		showWithScrollingInFrame(
				table, nohighlight, "core - value-based fg renderer with bg highlighter <--> shared without highl");
	}
	...
	public void interactiveTableCustomCoreRendererColor() {
		...
		nohighlight.setDefaultRenderer(Object.class, renderer);
		showWithScrollingInFrame(
				table, nohighlight, "core: custom colored renderer with bg highlighter <--> shared without highl");
	}
	...
	public void interactiveTableCoreRendererFirstSelected() {
		...
		showWithScrollingInFrame(nohighlight, "core: very first match is against selected");
	}
	...
	public void interactiveTableWithDoNothingHighlighter() {
		...
		showWithScrollingInFrame(
				table, new JXTable(table.getModel()), "selection: empty highlighter <--> no highlighter");
	}
