...
public class JXErrorPaneVisualCheck extends InteractiveTestCase {
	...
	public void interactiveMinimalError() {
		...
		ErrorInfo errorInfo = new ErrorInfo("Error", e.getMessage(), html.toString(), null, e, ErrorLevel.SEVERE, null);
	...
	public void interactiveLongMessageText() {
		ErrorInfo errorInfo = new ErrorInfo(
				...
				"The request cannot be carried out\n1\n2\n3\n4\n5\n6\n7"
						+ "\n8\n9\n0\n1\n2\n3\n4\nThis text should be shown in scroll pane.",
				"Server Error",
				null,
				new Exception(),
				Level.SEVERE,
	...
	public void interactiveTooSmall() {
		JXErrorPane.showDialog(
				null,
				new ErrorInfo("Title", "This is a test!", null, null, new Exception("This is a test!"), null, null));
	}
	...
	public void interactiveSetNullErrorInfo() {
		...
		try {
			...
			assertEquals(
					"ErrorInfo can\'t be null. Provide valid ErrorInfo object.",
					e.getMessage(),
