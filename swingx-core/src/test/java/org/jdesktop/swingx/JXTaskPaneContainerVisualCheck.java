...
public class JXTaskPaneContainerVisualCheck extends InteractiveTestCase {
	...
	public void interactiveAccordion() {
		JXTaskPaneContainer container = new JXTaskPaneContainer() {
			...
			private void grabExpansionControl(JXTaskPane comp) {
				...
				comp.addPropertyChangeListener("collapsed", getExpansionListener());
			}
	...
	public void interactiveRemovalTest() {
		...
		frame.add(
				new JButton(new AbstractAction("Remove Second") {
					@Override
					public void actionPerformed(ActionEvent e) {
	...
	public abstract class AbstractLBContentPanel<T extends Object> extends JPanel {
