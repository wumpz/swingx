...
public class CalendarUtilsTest extends InteractiveTestCase {
	...
	public void testStartOfYearWithReturn() {
		...
		assertEquals(
				startOf10YearsFuture,
				midJune.getTime(),
				"start of year with return must be same as changing start-of-year");
	}
	...
	public void testWeekOfYearInFeb() {
		...
		assertTrue(
				...
				"expected calendar before firstOfFeb " + todayGerman.getTime() + " / " + startOfFirstOfFeb);
	}
