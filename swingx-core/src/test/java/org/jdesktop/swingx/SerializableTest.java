...
public class SerializableTest extends InteractiveTestCase {
	...
	public void testTableHeader() throws Exception {
		...
		if (javax.swing.plaf.synth.SynthLookAndFeel.class.isAssignableFrom(
				Class.forName(UIManager.getSystemLookAndFeelClassName()))) {
			LOG.warning(
					"Table header is not serializable on Linux when using Synth or derived LaFs due to javax.swing.plaf.synth.SynthLabelUI being non serializable.");
			return;
		}
