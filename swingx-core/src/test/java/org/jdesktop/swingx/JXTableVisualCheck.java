...
public class JXTableVisualCheck extends JXTableUnitTest {
			...
			public void sorterChanged(RowSorterEvent e) {
				if (e.getType() == Type.SORT_ORDER_CHANGED) {
					...
					List<? extends SortKey> sortKeys =
							new ArrayList<SortKey>(e.getSource().getSortKeys());
					// remove primary
	...
	public static class SortAwareTableColumnExt extends TableColumnExt {
		...
		public static final String DESCENDING_CHAR = " \u25bf";
		public static final String ASCENDING_CHAR = " \u25b5";

		public static final String SORT_ORDER_KEY = "columnExt.SortOrder";
	...
	public void interactiveRevalidateOnUpdateWithFilter() {
		...
		RowFilter<TableModel, Integer> tm = RowFilter.regexFilter(".*AA.*", 0);
	...
	private DefaultTableModel createMultiSortModel() {
		...
		DefaultTableModel model = new DefaultTableModel(20, 4) {
			...
			@Override
			public Class<?> getColumnClass(int columnIndex) {
				return columnIndex == getColumnCount() - 1 ? Integer.class : super.getColumnClass(columnIndex);
			}
		};
	...
	public void interactiveUpdateUIEditors() {
		DefaultTableModel model = new DefaultTableModel(5, 5) {
			...
			@Override
			public Class<?> getColumnClass(int columnIndex) {
				if (getValueAt(0, columnIndex) == null) return super.getColumnClass(columnIndex);
	...
	public void interactiveToggleEditProperties() {
		...
		JXFrame frame = wrapWithScrollingInFrame(
				table,
				new JButton("something to focus"),
	...
	public void interactiveTestExpandsToViewportWidth() {
		...
		Action toggleModel = new AbstractAction("toggle model") {
			...
			public void actionPerformed(ActionEvent e) {
				table.setModel(
						table.getModel() == sortableTableModel ? new DefaultTableModel(20, 4) : sortableTableModel);
			}
		};
