...
public class JXTitledPanelTest extends InteractiveTestCase {
	...
	public void testTitleNotifyPropertyValue() {
		...
		assertEquals(panel.getTitle(), report.getLastNewValue("title"), "new property value must be equal to getTitle");
	}
	...
	public void interactiveRToL() {
		...
		//        panel.getContentContainer().setLayout(new BoxLayout(panel.getContentContainer(),
		// BoxLayout.PAGE_AXIS));
