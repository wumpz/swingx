...
public class XLocalizeIssues extends InteractiveTestCase {
	...
	private static final Logger LOG = Logger.getLogger(XLocalizeIssues.class.getName());
	...
	public void interactiveErrorPane() {
		...
		final JXFrame frame = wrapWithScrollingInFrame(table, "ErrorPane and default locale?");
	...
	public void interactiveFileChooser() {
		final JXTable table = new JXTable(10, 3);
		table.getColumnExt(0).setTitle(Locale.getDefault().getLanguage());
		final JXFrame frame = wrapWithScrollingInFrame(table, "FileChooser and default locale?");
		Action toggleLocale = new AbstractActionExt("toggleLocale") {
	...
	public void interactiveOptionPane() {
		final JXTable table = new JXTable(10, 3);
		table.getColumnExt(0).setTitle(Locale.getDefault().getLanguage());
		final JXFrame frame = wrapWithScrollingInFrame(table, "JOptionPane and default locale?");
		Action toggleLocale = new AbstractActionExt("toggleLocale") {
