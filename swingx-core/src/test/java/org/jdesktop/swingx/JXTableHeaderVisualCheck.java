...
public class JXTableHeaderVisualCheck extends InteractiveTestCase {
	...
	private static final Logger LOG = Logger.getLogger(JXTableHeaderVisualCheck.class.getName());
	...
	public void interactiveColumnToolTip() {
		...
		for (TableColumn column : table.getColumns()) {
			((TableColumnExt) column).setToolTipText("tip: " + column.getHeaderValue());
		}
