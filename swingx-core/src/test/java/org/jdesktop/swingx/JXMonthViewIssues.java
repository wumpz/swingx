...
public class JXMonthViewIssues extends InteractiveTestCase {
	...
	public void testModelSelectionUpdate() {
		...
		//                        monthView.getSelectionModel().getSelectionMode());
		//
		//        // The JXMonthView uses an underlying model mode of single interval selection when it is in week
		// selection mode.
	...
	public void testTimeZoneChangeTodayNotification() {
		...
		TestUtils.assertPropertyChangeEvent(report, "today", today.getTime(), otherToday.getTime(), false);
