...
public class JXListVisualCheck extends InteractiveTestCase { // JXListTest {
	...
	public void interactiveTestCompareFocusedCellBackground() {
		...
		JXFrame frame = wrapWithScrollingInFrame(xlist, list, "unselectedd focused background: JXList/JList");
	...
	public void interactiveTestTablePatternFilter5() {
		...
		list.setHighlighters(
				new ColorHighlighter( // columns not really important, ListAdapter.getXXValue
						// uses row only
						new PatternPredicate(pattern, 0), null, Color.red));
		showWithScrollingInFrame(list, "PatternHighlighter: " + pattern);
	}

	public void interactiveTestTableAlternateHighlighter1() {
		JXList list = new JXList(listModel);
		list.addHighlighter(HighlighterFactory.createSimpleStriping(HighlighterFactory.LINE_PRINTER));
	...
	public void interactiveTestRolloverHighlight() {
		...
		ColorHighlighter rollover =
				new ColorHighlighter(HighlightPredicate.ROLLOVER_ROW, new Color(0xF0, 0xF0, 0xE0), null);
	...
	public void interactiveTestRolloverHighlightMultiColumn() {
		...
		list.addHighlighter(new ColorHighlighter(HighlightPredicate.ROLLOVER_ROW, new Color(0xF0, 0xF0, 0xE0), null));
