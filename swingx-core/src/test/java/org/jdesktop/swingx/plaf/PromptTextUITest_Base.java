...
public abstract class PromptTextUITest_Base {
	...
	public void testGetLabelComponent() {
		...
		assertEquals(
				textComponent.getBorder().getBorderInsets(textComponent),
	...
	public void testGetPreferredSize() {
		...
		assertEquals(
				textComponent.getPreferredSize(),
				ui.getPromptComponent(textComponent).getPreferredSize());

		textComponent.setText("text");
		assertFalse(textComponent
				.getPreferredSize()
				.equals(ui.getPromptComponent(textComponent).getPreferredSize()));
	}
