...
public class JXList extends JList {
	...
	public void resetSortOrder() {
		if (hasSortController()) getSortController().resetSortOrders();
	}
	...
	public void toggleSortOrder() {
		if (hasSortController()) getSortController().toggleSortOrder(0);
	}
	...
	public void setSortOrder(SortOrder sortOrder) {
		if (hasSortController()) getSortController().setSortOrder(0, sortOrder);
	}
	...
	public SortOrder getSortOrder() {
		if (hasSortController()) return getSortController().getSortOrder(0);
	...
	public void setCellRenderer(ListCellRenderer renderer) {
		...
		if (forceFire) firePropertyChange("cellRenderer", null, delegatingRenderer);
	}
