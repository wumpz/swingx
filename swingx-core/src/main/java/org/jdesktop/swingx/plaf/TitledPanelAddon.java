...
public class TitledPanelAddon extends AbstractComponentAddon {
	...
	protected void addBasicDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
		...
		defaults.add(
				...
				new PainterUIResource<JXTitledPanel>(
		...
		if (isPlastic()) {
			...
			defaults.add(
					...
					new PainterUIResource<JXTitledPanel>(new MattePainter(
							new GradientPaint(0, 0, new Color(49, 121, 242), 0, 1, new Color(198, 211, 247)), true)));
		} else {
			defaults.add("JXTitledPanel.titleForeground", new ColorUIResource(Color.WHITE));
			defaults.add(
					"JXTitledPanel.titlePainter",
		...
		defaults.add(
				...
				new PainterUIResource<JXTitledPanel>(new MattePainter(
						new GradientPaint(
								...
								1,
								UIManagerExt.getSafeColor(
										"InternalFrame.activeTitleBackground", new ColorUIResource(198, 211, 247))),
						true)));
	}
}
