...
public class TaskPaneAddon extends AbstractComponentAddon {
	...
	protected void addMetalDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
		...
		defaults.add(
				"TaskPane.titleOver",
				new ColorUIResource(MetalLookAndFeel.getControl().darker()));
	...
	protected void addWindowsDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
		...
		if (addon instanceof WindowsLookAndFeelAddons) {
			...
			if (WindowsLookAndFeelAddons.HOMESTEAD_VISUAL_STYLE.equalsIgnoreCase(xpStyle)) {
				...
				defaults.add("TaskPane.background", new ColorUIResource((Color)
						toolkit.getDesktopProperty("win.3d.backgroundColor")));
				defaults.add("TaskPane.specialTitleBackground", new ColorUIResource(33, 89, 201));
				defaults.add("TaskPane.titleBackgroundGradientStart", new ColorUIResource(Color.WHITE));
				defaults.add("TaskPane.titleBackgroundGradientEnd", new ColorUIResource((Color)
						toolkit.getDesktopProperty("win.frame.inactiveCaptionColor")));
				defaults.add("TaskPane.titleForeground", new ColorUIResource((Color)
						toolkit.getDesktopProperty("win.frame.inactiveCaptionTextColor")));
