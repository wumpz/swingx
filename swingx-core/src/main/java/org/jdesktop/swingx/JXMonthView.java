...
public class JXMonthView extends JComponent {
	...
	public Calendar getCalendar() {
		...
		if (cal == null) throw new IllegalStateException("must not be called before instantiation is complete");
	...
	public void setDayForeground(int dayOfWeek, Color c) {
		if ((dayOfWeek < Calendar.SUNDAY) || (dayOfWeek > Calendar.SATURDAY)) {
			throw new IllegalArgumentException(
					"dayOfWeek must be in [Calendar.SUNDAY ... " + "Calendar.SATURDAY] but was " + dayOfWeek);
		}
	...
	public void addNotify() {
		...
		if (todayTimer == null) {
			todayTimer = new Timer(secondsTillTomorrow * 1000, new ActionListener() {
				@Override
