...
public class JXTitledSeparator extends JXPanel {
	...
	protected void updateTitle() {
		...
		if (c == null || c instanceof ColorUIResource) setForeground(UIManager.getColor("TitledBorder.titleColor"));

		Font f = label.getFont();
		if (f == null || f instanceof FontUIResource) setFont(UIManager.getFont("TitledBorder.font"));
	}
