...
public class JXFindPanel extends AbstractPatternPanel {
	...
	protected void bind() {
		...
		getActionContainerFactory()
				.configureButton(backCheck, getAction(PatternModel.MATCH_BACKWARDS_ACTION_COMMAND), null);
	}
	...
	protected int doSearch() {
		int foundIndex = searchable.search(
				getPatternModel().getPattern(),
				getPatternModel().getFoundIndex(),
	...
	protected void initExecutables() {
		...
		getActionMap()
				.put(FIND_PREVIOUS_ACTION_COMMAND, createBoundAction(FIND_PREVIOUS_ACTION_COMMAND, "findPrevious"));
